...
export namespace PlayerEvents {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: PlayerEvents): void {
    PlayerEvents.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): PlayerEvents {
    return PlayerEvents.getTypeScriptAlgebraicType().deserialize(reader);
  }
